  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-400 via-pink-300 to-blue-400 dark:from-gray-900 dark:via-blue-950 dark:to-black overflow-hidden transition-colors duration-500">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-96 h-96 bg-purple-500/30 dark:bg-blue-500/20 rounded-full blur-3xl transition-colors duration-500" />
        <div className="absolute top-1/2 -left-40 w-96 h-96 bg-pink-500/30 dark:bg-blue-600/20 rounded-full blur-3xl transition-colors duration-500" />
        <div className="absolute -bottom-40 right-1/3 w-96 h-96 bg-blue-500/30 dark:bg-blue-400/20 rounded-full blur-3xl transition-colors duration-500" />
      </div>
      ...
      <nav className="relative z-10 backdrop-blur-xl bg-white/10 dark:bg-black/30 border-b border-white/20 dark:border-blue-500/30 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate("/")}>
            ...
            <span className="text-2xl font-bold text-white">ChronoDeX</span>
          </div>
          <Button
            onClick={() => navigate(isAuthenticated ? "/dashboard" : "/auth")}
            className="bg-white/20 hover:bg-white/30 text-white backdrop-blur-sm border border-white/30 dark:bg-blue-500/30 dark:hover:bg-blue-500/40 dark:border-blue-500/40"
          >
      ...
      <main className="relative z-10">
        ...
        >
          ...
          >
            <img src="/logo.svg" alt="ChronoDeX" className="w-24 h-24 mx-auto" />
          </motion.div>
      ...
      <footer className="relative z-10 backdrop-blur-xl bg-white/10 dark:bg-black/30 border-t border-white/20 dark:border-blue-500/30 py-8 transition-colors duration-300">
